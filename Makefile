...
provision:
	...
	kubectl config set-context k3s-libvirt
...
destroy:
	...
	# rm -rf .vagrant*
	kubectl config delete-context k3s-libvirt
	kubectl config delete-cluster k3s-libvirt
	kubectl config delete-user k3s-libvirt
